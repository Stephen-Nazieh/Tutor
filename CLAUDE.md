...
- `services/adk/` — Optional Google ADK microservice (Express + TypeScript) for AI agents.
...
cd services/adk && npm run dev    # ADK_START_LISTENER=true tsx src/server/index.ts, :8080
```
