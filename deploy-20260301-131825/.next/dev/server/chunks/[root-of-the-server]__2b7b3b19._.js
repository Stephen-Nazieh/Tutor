;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="76867d76-3ba9-4e7c-f88e-06746b2be421")}catch(e){}}();
module.exports = [
...
async function getHandler(req, session) {
    try {
        ...
        if (myGroups) {
            ...
            const memberships = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].studyGroupMember.findMany({
                where: {
            ...
            groups = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].studyGroup.findMany({
                where,
                include: {
                    creator: {
                        select: {
...
async function postHandler(req, session) {
    ...
    try {
        ...
        const group = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].studyGroup.findUnique({
            where: {
                id: groupId
            },
            include: {
        ...
        const existingMembership = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].studyGroupMember.findFirst({
            where: {
                groupId,
                studentId: session.user.id
            }
        ...
        // Create membership
        const membership = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].studyGroupMember.create({
            data: {
                groupId,
                studentId: session.user.id,
                role: 'member'
...
async function putHandler(req, session) {
    ...
    try {
        ...
        const group = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].studyGroup.create({
            data: {
                name: safeName,
...
async function deleteHandler(req, session) {
    ...
    try {
        ...
        // Find membership
        const membership = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].studyGroupMember.findFirst({
            where: {
                groupId,
                studentId: session.user.id
            },
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].studyGroupMember.delete({
            where: {
                id: membership.id
            }
        });
...
//# debugId=76867d76-3ba9-4e7c-f88e-06746b2be421
//# sourceMappingURL=%5Broot-of-the-server%5D__2b7b3b19._.js.map