;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="4f794705-5e8e-91f4-dacd-fb5462ebf03b")}catch(e){}}();
module.exports = [
...
const POST = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withCsrf"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(async (req, session)=>{
    ...
    if (data.curriculumId) {
        const ownedCurriculum = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].curriculum.findFirst({
            where: {
    ...
    const room = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$video$2f$daily$2d$provider$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dailyProvider"].createRoom(session.user.id, {
        maxParticipants: data.maxStudents + 1,
        durationMinutes: data.durationMinutes,
        enableRecording: data.enableRecording
    });
    // Create meeting token for tutor (as owner)
    const tutorToken = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$video$2f$daily$2d$provider$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dailyProvider"].createMeetingToken(room.id, session.user.id, {
        isOwner: true,
        durationMinutes: data.durationMinutes
    });
    // Store class session in database
    const classSession = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].liveSession.create({
        data: {
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(async (req, session)=>{
    ...
    const activeSessions = (await Promise.all(sessions.map(async (s)=>{
...
//# debugId=4f794705-5e8e-91f4-dacd-fb5462ebf03b
//# sourceMappingURL=%5Broot-of-the-server%5D__fb1395b3._.js.map