;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="9ccf06e3-d78a-ff1e-5de7-f8f2d543c948")}catch(e){}}();
...
"[project]/ADK_WORKSPACE/TutorMekimi/tutorme-app/src/app/[locale]/student/live/[sessionId]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StudentLiveSessionPage() {
    ...
    const { data: authSession } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"])();
    ...
    const [joinData, setJoinData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const getCsrfToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StudentLiveSessionPage.useCallback[getCsrfToken]": async ()=>{
            try {
                const res = await fetch('/api/csrf', {
                    credentials: 'include'
                });
                const data = await res.json().catch({
                    "StudentLiveSessionPage.useCallback[getCsrfToken]": ()=>({})
                }["StudentLiveSessionPage.useCallback[getCsrfToken]"]);
    ...
    const fetchJoinData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StudentLiveSessionPage.useCallback[fetchJoinData]": async ()=>{
            setLoading(true);
            setError(null);
            try {
                ...
                if (!res.ok) {
                    const raw = await res.text().catch({
                        "StudentLiveSessionPage.useCallback[fetchJoinData]": ()=>''
                    }["StudentLiveSessionPage.useCallback[fetchJoinData]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudentLiveSessionPage.useEffect": ()=>{
            if (!sessionId) return;
            fetchJoinData();
        }
    }["StudentLiveSessionPage.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudentLiveSessionPage.useEffect": ()=>{
            ...
            const alreadySeen = ("TURBOPACK compile-time truthy", 1) ? window.sessionStorage.getItem(key) : "TURBOPACK unreachable";
            if (!alreadySeen) {
    ...
    const openVideoClassroom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StudentLiveSessionPage.useCallback[openVideoClassroom]": ()=>{
            const roomUrl = joinData?.roomUrl;
            const token = joinData?.token;
            if (!roomUrl) {
                __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Room URL is not available');
                return;
            }
...
_s(StudentLiveSessionPage, "LCYEfPvXIVdGKoMW+gy45Fz3QNA=", false, function() {
    return [
...
_c = StudentLiveSessionPage;
var _c;
__turbopack_context__.k.register(_c, "StudentLiveSessionPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# debugId=9ccf06e3-d78a-ff1e-5de7-f8f2d543c948
//# sourceMappingURL=ADK_WORKSPACE_TutorMekimi_tutorme-app_src_app_%5Blocale%5D_student_live_70f6ba2c._.js.map