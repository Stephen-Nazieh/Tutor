;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="20003873-c6c9-de72-38d1-e13ae3a85cf1")}catch(e){}}();
...
}`])},479417,e=>e.a(async(t,r)=>{try{var n=e.i(620971),i=e.i(384030),a=e.i(908286),s=e.i(738597);e.i(688768);var o=e.i(257357),l=e.i(909105),u=e.i(748846),c=e.i(892842),d=t([i,s]);[i,s]=d.then?(await d)():d;let p=(0,i.withCsrf)((0,i.withAuth)(async(e,t,r)=>{let d=await (0,a.getParamAsync)(r?.params,"id");if(!d)return n.NextResponse.json({error:"Course ID required"},{status:400});let[p]=await s.drizzleDb.select({id:o.curriculum.id,subject:o.curriculum.subject,languageOfInstruction:o.curriculum.languageOfInstruction,courseMaterials:o.curriculum.courseMaterials}).from(o.curriculum).where((0,l.eq)(o.curriculum.id,d));if(!p)throw new i.NotFoundError("Course not found");let h=await e.json().catch(()=>({})),m="number"==typeof h.typicalLessonMinutes?Math.min(120,Math.max(15,h.typicalLessonMinutes)):45,g="string"==typeof h.curriculumText?h.curriculumText.trim():"",f="string"==typeof h.notesText?h.notesText.trim():"",y=p.courseMaterials??{},x=g||y.editableCurriculum||y.curriculumText||"",w=(f||y.notesText||"").trim();if(!(x.trim()||w))return n.NextResponse.json({error:"Upload at least one of curriculum, notes, or topics before generating the outline."},{status:400});g&&(y.curriculumText=g),f&&(y.notesText=f);let R=f||y.notesText||"",b=(0,c.courseOutlineAsModulesPrompt)({curriculumText:x.trim()||w||"(No curriculum; generate from notes.)",notesText:x.trim()&&R?R:void 0,subject:p.subject,typicalLessonMinutes:m,language:p.languageOfInstruction??"en"}),v=await (0,u.generateWithFallback)(b,{temperature:.4,maxTokens:4e3,skipCache:!0}),$=[],T=[];try{let e=v.content.match(/\[[\s\S]*\]/);if(e){let t=JSON.parse(e[0]);Array.isArray(t)&&(T=($=t.filter(e=>e&&"object"==typeof e&&"title"in e&&"lessons"in e).map(e=>{let t=(Array.isArray(e.lessons)?e.lessons:[]).filter(e=>e&&"object"==typeof e&&null!=e.title).map(e=>({title:String(e.title??"Lesson"),durationMinutes:"number"==typeof e.durationMinutes?e.durationMinutes:m})),r=Array.isArray(e.tasks)?e.tasks.filter(e=>e&&"object"==typeof e&&null!=e.title).map(e=>({title:String(e.title)})):void 0;return{title:String(e.title??"Module"),description:"string"==typeof e.description?e.description:void 0,notes:"string"==typeof e.notes?e.notes:void 0,tasks:r?.length?r:void 0,lessons:t}})).flatMap(e=>e.lessons))}}catch{$=[],T=[]}return y.outline=T,y.outlineModules={modules:$},await s.drizzleDb.update(o.curriculum).set({courseMaterials:y}).where((0,l.eq)(o.curriculum.id,d)),n.NextResponse.json({outline:T,outlineModules:{modules:$},message:"Course outline generated. You can populate the class schedule from it."})},{role:"TUTOR"}));e.s(["POST",0,p]),r()}catch(e){r(e)}},!1),760358,e=>e.a(async(t,r)=>{try{var n=e.i(78315),i=e.i(586961),a=e.i(196657),s=e.i(899733),o=e.i(233979),l=e.i(631683),u=e.i(840960),c=e.i(711373),d=e.i(699699),p=e.i(521140),h=e.i(205260),m=e.i(500249),g=e.i(431740),f=e.i(82608),y=e.i(635207),x=e.i(193695);e.i(708038);var w=e.i(447430),R=e.i(479417),b=t([R]);[R]=b.then?(await b)():b;let T=new n.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/tutor/courses/[id]/materials/outline/route",pathname:"/api/tutor/courses/[id]/materials/outline",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/ADK_WORKSPACE/TutorMekimi/tutorme-app/src/app/api/tutor/courses/[id]/materials/outline/route.ts",nextConfigOutput:"",userland:R}),{workAsyncStorage:A,workUnitAsyncStorage:S,serverHooks:C}=T;function v(){return(0,a.patchFetch)({workAsyncStorage:A,workUnitAsyncStorage:S})}async function $(e,t,r){T.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/tutor/courses/[id]/materials/outline/route";n=n.replace(/\/index$/,"")||"/";let a=await T.prepare(e,t,{srcPage:n,multiZoneDraftMode:!1});if(!a)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:R,params:b,nextConfig:v,parsedUrl:$,isDraftMode:A,prerenderManifest:S,routerServerContext:C,isOnDemandRevalidate:E,revalidateOnlyGenerated:M,resolvedPathname:P,clientReferenceManifest:O,serverActionsManifest:_}=a,k=(0,u.normalizeAppPath)(n),N=!!(S.dynamicRoutes[k]||S.routes[P]),q=async()=>((null==C?void 0:C.render404)?await C.render404(e,t,$,!1):t.end("This page could not be found"),null);if(N&&!A){let e=!!S.routes[P],t=S.dynamicRoutes[k];if(t&&!1===t.fallback&&!e){if(v.experimental.adapterPath)return await q();throw new x.NoFallbackError}}let z=null;!N||T.isDev||A||(z=P,z="/index"===z?"/":z);let D=!0===T.isDev||!N,j=N&&!D;_&&O&&(0,l.setManifestsSingleton)({page:n,clientReferenceManifest:O,serverActionsManifest:_});let I=e.method||"GET",U=(0,o.getTracer)(),L=U.getActiveScopeSpan(),F={params:b,prerenderManifest:S,renderOpts:{experimental:{authInterrupts:!!v.experimental.authInterrupts},cacheComponents:!!v.cacheComponents,supportsDynamicResponse:D,incrementalCache:(0,s.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:v.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,n,i)=>T.onRequestError(e,t,n,i,C)},sharedContext:{buildId:R}},H=new c.NodeNextRequest(e),B=new c.NodeNextResponse(t),K=d.NextRequestAdapter.fromNodeNextRequest(H,(0,d.signalFromNodeResponse)(t));try{let a=async e=>T.handle(K,F).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=U.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==p.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let i=r.get("next.route");if(i){let t=`${I} ${i}`;e.setAttributes({"next.route":i,"http.route":i,"next.span_name":t}),e.updateName(t)}else e.updateName(`${I} ${n}`)}),l=!!(0,s.getRequestMeta)(e,"minimalMode"),u=async s=>{var o,u;let c=async({previousCacheEntry:i})=>{try{if(!l&&E&&M&&!i)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await a(s);e.fetchMetrics=F.renderOpts.fetchMetrics;let o=F.renderOpts.pendingWaitUntil;o&&r.waitUntil&&(r.waitUntil(o),o=void 0);let u=F.renderOpts.collectedTags;if(!N)return await (0,m.sendResponse)(H,B,n,F.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,g.toNodeOutgoingHttpHeaders)(n.headers);u&&(t[y.NEXT_CACHE_TAGS_HEADER]=u),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==F.renderOpts.collectedRevalidate&&!(F.renderOpts.collectedRevalidate>=y.INFINITE_CACHE)&&F.renderOpts.collectedRevalidate,i=void 0===F.renderOpts.collectedExpire||F.renderOpts.collectedExpire>=y.INFINITE_CACHE?void 0:F.renderOpts.collectedExpire;return{value:{kind:w.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:i}}}}catch(t){throw(null==i?void 0:i.isStale)&&await T.onRequestError(e,t,{routerKind:"App Router",routePath:n,routeType:"route",revalidateReason:(0,h.getRevalidateReason)({isStaticGeneration:j,isOnDemandRevalidate:E})},!1,C),t}},d=await T.handleResponse({req:e,nextConfig:v,cacheKey:z,routeKind:i.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:S,isRoutePPREnabled:!1,isOnDemandRevalidate:E,revalidateOnlyGenerated:M,responseGenerator:c,waitUntil:r.waitUntil,isMinimalMode:l});if(!N)return null;if((null==d||null==(o=d.value)?void 0:o.kind)!==w.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(u=d.value)?void 0:u.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});l||t.setHeader("x-nextjs-cache",E?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),A&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let p=(0,g.fromNodeOutgoingHttpHeaders)(d.value.headers);return l&&N||p.delete(y.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||t.getHeader("Cache-Control")||p.get("Cache-Control")||p.set("Cache-Control",(0,f.getCacheControlHeader)(d.cacheControl)),await (0,m.sendResponse)(H,B,new Response(d.value.body,{headers:p,status:d.value.status||200})),null};L?await u(L):await U.withPropagatedContext(e.headers,()=>U.trace(p.BaseServerSpan.handleRequest,{spanName:`${I} ${n}`,kind:o.SpanKind.SERVER,attributes:{"http.method":I,"http.target":e.url}},u))}catch(t){if(t instanceof x.NoFallbackError||await T.onRequestError(e,t,{routerKind:"App Router",routePath:k,routeType:"route",revalidateReason:(0,h.getRevalidateReason)({isStaticGeneration:j,isOnDemandRevalidate:E})},!1,C),N)throw t;return await (0,m.sendResponse)(H,B,new Response(null,{status:500})),null}}e.s(["handler",()=>$,"patchFetch",()=>v,"routeModule",()=>T,"serverHooks",()=>C,"workAsyncStorage",()=>A,"workUnitAsyncStorage",()=>S]),r()}catch(e){r(e)}},!1),412171,e=>{e.v(t=>Promise.all(["server/chunks/b1c00_TutorMekimi_tutorme-app_src_lib_security_suspicious-activity_ts_7865686f._.js"].map(t=>e.l(t))).then(()=>t(145830)))},443460,e=>{e.v(t=>Promise.all(["server/chunks/[externals]_ioredis_c74819ca._.js"].map(t=>e.l(t))).then(()=>t(693545)))},571363,e=>{e.v(t=>Promise.all(["server/chunks/ADK_WORKSPACE_TutorMekimi_tutorme-app_src_lib_security_api-key_ts_45091e81._.js"].map(t=>e.l(t))).then(()=>t(175922)))}];

//# debugId=20003873-c6c9-de72-38d1-e13ae3a85cf1
//# sourceMappingURL=%5Broot-of-the-server%5D__e630fcab._.js.map