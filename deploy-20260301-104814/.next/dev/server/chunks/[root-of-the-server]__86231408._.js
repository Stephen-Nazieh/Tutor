;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="37105e72-3363-7f5e-22ca-6fba9832167a")}catch(e){}}();
module.exports = [
...
async function initializeDailyQuests() {
    for (const q of DEFAULT_QUESTS){
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].mission.findFirst({
            where: {
                type: 'daily',
                title: q.title
            }
        ...
        if (!existing) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].mission.create({
                data: {
                    title: q.title,
...
async function generateDailyQuests(userId) {
    ...
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].userDailyQuest.findMany({
        where: {
            userId,
            date: {
                gte: today,
    ...
    const dailyMissions = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].mission.findMany({
        where: {
            type: 'daily',
            isActive: true
        }
    ...
    const userQuests = await Promise.all(selected.map((mission)=>__TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].userDailyQuest.create({
            data: {
                userId,
...
async function getTodayQuests(userId) {
    const today = startOfDay(new Date());
    const quests = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].userDailyQuest.findMany({
        where: {
            userId,
            date: {
                gte: today,
...
async function updateQuestProgress(userId, questType, _progressAmount = 1) {
    const today = startOfDay(new Date());
    const userQuests = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].userDailyQuest.findMany({
        where: {
            userId,
            date: {
                gte: today,
    ...
    const matching = userQuests.find((q)=>getQuestTypeFromRequirement(q.mission.requirement) === questType);
    if (!matching) return null;
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].userDailyQuest.update({
        where: {
            id: matching.id
        },
        data: {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$gamification$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["awardXp"])(userId, matching.mission.xpReward, 'quest_complete', {
...
async function getQuestSummary(userId) {
    const today = startOfDay(new Date());
    const todayQuests = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].userDailyQuest.findMany({
        where: {
            userId,
            date: {
                gte: today,
    ...
    const totalXp = todayQuests.filter((q)=>q.completed).reduce((sum, q)=>sum + q.mission.xpReward, 0);
    return {
        completed,
        total,
        totalXp,
...
//# debugId=37105e72-3363-7f5e-22ca-6fba9832167a
//# sourceMappingURL=%5Broot-of-the-server%5D__86231408._.js.map