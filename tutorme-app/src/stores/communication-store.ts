...
const generateDemoMessages = (): Message[] => [
  {
    ...
    content:
      "Hi, I'm having trouble understanding problem 3 from yesterday's assignment. Could you explain the concept of derivatives again?",
  ...
  },
  {
    ...
    content:
      "I won't be able to attend tomorrow's class due to a family event. Will there be a recording available?",
  ...
  },
  {
    ...
    subject: 'Thank you!',
    content:
      'Just wanted to say thanks for the extra help yesterday. I finally understood the concept!',
  ...
  },
  {
    ...
    content:
      "I'm facing some technical issues with my laptop. Could I get a 2-day extension for the upcoming assignment?",
...
const generateDemoTemplates = (): MessageTemplate[] => [
  {
    ...
    content:
      "Welcome to the course! I'm excited to have you join us. If you have any questions, feel free to reach out.",
    category: 'general',
  },
  {
    id: '2',
    ...
    content:
      'Just a friendly reminder that the assignment is due tomorrow. Let me know if you need any help!',
    category: 'reminder',
  },
  {
    id: '3',
    title: 'Great Work!',
    content:
      'Excellent work on the recent assignment! Your understanding of the concepts has really improved.',
    category: 'feedback',
  },
  {
    id: '4',
    ...
    content:
      "Unfortunately, tomorrow's class is cancelled due to unforeseen circumstances. We'll reschedule soon.",
    category: 'course',
  },
  {
    id: '5',
    ...
    content:
      "I understand you're experiencing technical difficulties. Let's troubleshoot this together.",
    category: 'technical',
  },
]
...
export const useCommunicationStore = create<CommunicationState>()(
  immer((set, get) => ({
    ...
    setShowQuickRepliesManager: show =>
      set(state => {
    ...
    addComposeAttachment: attachment =>
      set(state => {
        state.composeAttachments.push(attachment)
      }),

    removeComposeAttachment: attachmentId =>
      set(state => {
    ...
    translateMessage: (messageId, translatedContent, translatedFrom) =>
      set(state => {
        const msg = state.messages.find(m => m.id === messageId)
        if (msg) {
...
export const useShowQuickRepliesManager = () =>
  useCommunicationStore(state => state.showQuickRepliesManager)
...
export const useVoiceRecordingDuration = () =>
  useCommunicationStore(state => state.voiceRecordingDuration)
...
export const usePresenceStatusForUser = (userId: string) =>
  useCommunicationStore(state => state.presenceStatus[userId])
export const useIsWebSocketConnected = () =>
  useCommunicationStore(state => state.isWebSocketConnected)
