...
class EncryptionService {
  ...
  encrypt(data: string): string {
    ...
    const cipher = crypto.createCipheriv(CACHE_CONFIG.ENCRYPTION_ALGORITHM, this.key, iv)
  ...
  decrypt(encryptedData: string): string {
    ...
    const decipher = crypto.createDecipheriv(CACHE_CONFIG.ENCRYPTION_ALGORITHM, this.key, iv)
