...
export const PERMISSIONS = {
  ...
  // Parent
  PARENT_VIEW_CHILDREN: 'parent:children:read',
  PARENT_VIEW_REPORTS: 'parent:reports:read',
  PARENT_MANAGE_PAYMENTS: 'parent:payments',
  // Student
...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ADMIN: [
    ...
    PERMISSIONS.PARENT_VIEW_CHILDREN,
    PERMISSIONS.PARENT_VIEW_REPORTS,
    PERMISSIONS.PARENT_MANAGE_PAYMENTS,
