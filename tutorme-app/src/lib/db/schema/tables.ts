...
export const builderTask = pgTable('BuilderTask', {
  id: text('id').primaryKey().notNull(),
  curriculumId: text('curriculumId').notNull(),
  lessonId: text('lessonId').notNull(),
  ...
  BuilderTask_curriculumId_lessonId_idx: index('BuilderTask_curriculumId_lessonId_idx').on(table.curriculumId, table.lessonId)
}))

export const builderTaskExtension = pgTable('BuilderTaskExtension', {
  id: text('id').primaryKey().notNull(),
  taskId: text('taskId').notNull(),
  ...
  BuilderTaskExtension_taskId_order_idx: index('BuilderTaskExtension_taskId_order_idx').on(table.taskId, table.order)
}))

export const builderTaskFile = pgTable('BuilderTaskFile', {
  id: text('id').primaryKey().notNull(),
  taskId: text('taskId').notNull(),
  name: text('name').notNull(),
  url: text('url').notNull(),
...
export const builderTaskVersion = pgTable('BuilderTaskVersion', {
  id: text('id').primaryKey().notNull(),
  taskId: text('taskId').notNull(),
