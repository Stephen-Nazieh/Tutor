...
export const chemistryContext: SubjectContext = {
  ...
  name: 'Chemistry',
  description:
    'Chemistry tutoring emphasizing molecular understanding, stoichiometry, and chemical reasoning',
  ...
  commonMistakes: [
    {
      ...
      correctivePrompt:
        'How many significant figures should your answer have? Check your given values.',
    },
    {
      id: 'unit_conversion',
      ...
      correctivePrompt:
        'What units does your answer need? Do you need to convert any given values first?',
    },
    {
      id: 'balancing',
    ...
    },
    {
      ...
      correctivePrompt:
        'What states are your reactants and products in? Does this affect the reaction?',
    },
  ],

  pedagogicalApproach: {
    socraticStyle:
      'Emphasize molecular-level understanding. Use particle diagrams. Connect macroscopic observations to microscopic behavior. Ask students to visualize atoms and molecules.',
    emphasisAreas: [
