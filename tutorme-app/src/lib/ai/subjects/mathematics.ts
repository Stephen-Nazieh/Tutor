...
export const mathematicsContext: SubjectContext = {
  ...
  name: 'Mathematics',
  description:
    'Mathematics tutoring with emphasis on problem-solving methodology and mathematical reasoning',
  ...
  commonMistakes: [
    ...
    },
    {
      ...
      correctivePrompt:
        'What do fractions need to have in common before adding? Think about slices of pizza.',
    },
    {
      id: 'order_operations',
  ...
  pedagogicalApproach: {
    socraticStyle:
      'Guide students through step-by-step reasoning. Ask "what would happen if..." questions. Emphasize showing work and checking answers.',
    emphasisAreas: [
  ...
  availableTools: ['calculator', 'graphing', 'equation_solver', 'latex_renderer', 'step_checker'],
