...
export const physicsContext: SubjectContext = {
  ...
  name: 'Physics',
  description:
    'Physics tutoring emphasizing conceptual understanding, problem-solving strategies, and physical intuition',
      ...
      exampleProblems: [
        {
          id: 'newton_1',
          question:
            'A 5kg box is pushed with a 20N force on a frictionless surface. What is its acceleration?',
        ...
        },
        {
          id: 'newton_2',
          question:
            'In a tug-of-war, if team A pulls with 500N and team B pulls with 500N, what is the tension in the rope?',
      ...
      exampleProblems: [
        {
          id: 'energy_1',
          question:
            'A ball is dropped from 10m. How fast is it going when it hits the ground? (ignore air resistance)',
      ...
      exampleProblems: [
        {
          id: 'circuit_1',
          question:
            'Two resistors (2Ω and 4Ω) are in series with a 12V battery. What is the current?',
  ...
  commonMistakes: [
    {
      ...
      correctivePrompt:
        'What units are given? What units do you need? Should you convert everything to meters and seconds first?',
    },
    {
      id: 'free_body',
      ...
      correctivePrompt:
        "Let's draw a free-body diagram. What objects are touching your system? What fields act on it?",
    },
    {
      id: 'sign_convention',
      ...
      correctivePrompt:
        'Which direction did you choose as positive? Does your answer make sense with that choice?',
    },
    {
      id: 'vector_scalar',
  ...
  pedagogicalApproach: {
    socraticStyle:
      'Emphasize physical intuition and conceptual understanding before equations. Use thought experiments and everyday analogies. Ask students to predict what will happen before calculating.',
    emphasisAreas: [
