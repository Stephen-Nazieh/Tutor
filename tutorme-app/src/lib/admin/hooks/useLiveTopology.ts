...
const STABLE_MOCK_SESSIONS: LiveSession[] = [
  ...
  },
  {
    ...
    tutorId: 'user-11',
    studentId: 'user-13',
    tutorIp: '198.51.100.2',
    studentIp: '198.51.100.4',
  ...
  },
  {
    ...
    tutorId: 'user-17',
    studentId: 'user-18',
    tutorIp: '198.51.100.8',
    studentIp: '198.51.100.9',
    subject: 'Physics',
    isActive: true,
