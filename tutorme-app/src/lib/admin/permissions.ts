...
export const PermissionGroups = [
  ...
  },
  {
    ...
    permissions: [
      {
        value: Permissions.FEATURES_READ,
        label: 'View Features',
        description: 'View feature flag configurations',
      },
      {
        value: Permissions.FEATURES_WRITE,
        label: 'Edit Features',
        description: 'Create and modify feature flags',
      },
      {
        value: Permissions.FEATURES_DELETE,
  ...
  },
  {
    ...
    permissions: [
      {
        value: Permissions.LLM_READ,
        label: 'View LLM',
        description: 'View LLM provider configurations',
      },
      {
        value: Permissions.LLM_WRITE,
        label: 'Edit LLM',
        description: 'Modify LLM providers and routing',
      },
  ...
  },
  {
    ...
    permissions: [
      {
        value: Permissions.SETTINGS_READ,
        label: 'View Settings',
        description: 'View system configuration',
      },
      {
        value: Permissions.SETTINGS_WRITE,
        label: 'Edit Settings',
  ...
  },
  {
    ...
    permissions: [
      {
        value: Permissions.ANALYTICS_READ,
        label: 'View Analytics',
        description: 'Access analytics dashboards',
      },
      {
        value: Permissions.ANALYTICS_EXPORT,
  ...
  },
  {
    ...
    permissions: [
      {
        value: Permissions.SECURITY_READ,
        label: 'View Security',
        description: 'View security settings',
      },
      {
        value: Permissions.SECURITY_WRITE,
        label: 'Edit Security',
  ...
  },
  {
    ...
    permissions: [
      {
        value: Permissions.PAYMENTS_READ,
        label: 'View Payments',
        description: 'View payment transactions',
      },
      {
        value: Permissions.WEBHOOKS_READ,
        label: 'View Webhooks',
        description: 'View webhook event logs',
      },
      {
        value: Permissions.API_KEYS_MANAGE,
        label: 'Manage API Keys',
        description: 'Create and revoke admin API keys',
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      {
        value: Permissions.ADMINS_DELETE,
        label: 'Remove Admins',
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        value: Permissions.SYSTEM_MAINTENANCE,
        label: 'Maintenance',
