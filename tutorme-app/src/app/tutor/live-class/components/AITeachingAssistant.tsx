...
// Generate demo insights based on class state
const generateDemoInsights = (students: LiveStudent[], duration: number): AIInsight[] => {
...
const generateDemoSocraticPrompts = (): SocraticPrompt[] => [
  {
    id: 'prompt-1',
...
export function AITeachingAssistant({ 
  ...
  // Generate insights based on class state
  useEffect(() => {
    const newInsights = generateDemoInsights(students, classDuration)
    setInsights(newInsights)
    setSocraticPrompts(generateDemoSocraticPrompts())
  }, [students, classDuration])
