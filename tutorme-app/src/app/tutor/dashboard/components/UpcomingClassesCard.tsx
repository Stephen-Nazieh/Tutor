            ...
            {classes.map((cls) => {
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link href={`/class/${cls.id}`} target="_blank" rel="noopener noreferrer" title="Classroom with whiteboard">
                    <Button size="sm" variant="outline">
                      <Video className="w-4 h-4 mr-1" />
                      Room
                    </Button>
                  </Link>
                  <Link href={`/tutor/live-class/${cls.id}`} title="Live Class Hub with AI">
