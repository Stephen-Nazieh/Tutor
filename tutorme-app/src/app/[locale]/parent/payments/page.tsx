...
const paymentHistory = [
  {
    id: '1',
    date: '2026-02-15',
    description: 'Mathematics Tutoring - Emily',
    amount: 800,
    status: 'completed',
    method: 'Credit Card',
  },
  {
    id: '2',
    date: '2026-02-10',
    description: 'Physics Class - Michael',
    amount: 600,
    status: 'completed',
    method: 'WeChat Pay',
  },
  {
    id: '3',
    date: '2026-02-01',
    description: 'English Tutoring - Emily',
    amount: 500,
    status: 'completed',
    method: 'Credit Card',
  },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-gray-500">Manage your payments and view transaction history</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="mt-1 text-sm text-green-600">¥1,800 remaining</p>
          </CardContent>
        </Card>
      </div>
