      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">View and manage all your teaching groups</p>
          </div>
        </div>
        <Button asChild>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            This page will display a detailed list of all your groups with filtering and search
            capabilities.
          </p>
