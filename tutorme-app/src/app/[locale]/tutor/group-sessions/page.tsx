  ...
  return (
    <div className="flex h-full min-h-full flex-col bg-white px-3 pb-0 lg:px-4">
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-4 pb-4">
        {/* Panel 1 - Create New Group Session */}
          ...
          <div className="panel-header panel-header-metallic w-full">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="panel-header-title">New Group Session</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="panel-header panel-header-metallic w-full">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="panel-header-title">Your Sessions</div>
                </div>
              </div>
            </div>
          </div>
