                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          setFormData(prev => ({
                            ...prev,
                            allowedAttempts: parseInt(e.target.value) || 1,
                          }))
                        }
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={v =>
                        setFormData(prev => ({
                          ...prev,
                          showCorrectAnswers: v as Quiz['showCorrectAnswers'],
                        }))
                      }
                    >
                      <SelectTrigger>
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          <h3 className="mb-4 font-medium">Active Assignments</h3>
        ...
        <CardContent>
          <div className="space-y-4">
            {analytics.questionAnalytics.map((qa: any, index: number) => (
              <div key={qa.questionId} className="rounded-lg border p-4">
                <div className="mb-2 flex items-start justify-between">
                  ...
                  <Badge
                    variant={
                      qa.difficultyIndex > 0.7
                        ? 'default'
                        : qa.difficultyIndex > 0.4
                          ? 'secondary'
                          : 'destructive'
                    }
                  >
                    {qa.correctCount}/{qa.correctCount + qa.incorrectCount + qa.partialCount}{' '}
                    correct
                  </Badge>
                </div>
