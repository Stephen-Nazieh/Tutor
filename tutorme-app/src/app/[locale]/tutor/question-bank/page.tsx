...
export default function QuestionBankPage() {
  ...
  const handleEdit = (question: QuestionBankItem) => {
    ...
    setFormData({
      ...
      tags: question.tags,
      subject:
        question.subject && SUBJECT_OPTIONS.includes(question.subject)
          ? question.subject
          : question.subject
            ? 'Other'
            : '',
            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    setFormData(prev => ({ ...prev, subject: value === '__none__' ? '' : value }))
                  }
                >
                  <SelectTrigger>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v =>
                      setFormData(prev => ({ ...prev, difficulty: v as QuestionDifficulty }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                        ...
                        <input
                          ...
                          checked={
                            formData.type === 'multi_select'
                              ? ((formData.correctAnswer as unknown as string[]) || []).includes(
                                  option
                                )
                      ...
                      <div className="mb-2 text-sm text-muted-foreground">
                        ...
                        {(question.options as string[]).map((o, i) => (
                          <span
                            key={i}
                            className={
                              question.correctAnswer === o ? 'font-medium text-green-600' : ''
                            }
                          >
                            {o}
                            {i < (question.options as string[]).length - 1 ? ', ' : ''}
                          </span>
                        ))}
                      </div>
                    )}
