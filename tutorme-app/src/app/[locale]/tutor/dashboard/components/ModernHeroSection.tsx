...
export function ModernHeroSection({ stats, loading, onCreateCourse }: ModernHeroSectionProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-8 shadow-2xl border-none neon-border-indigo">
      {/* Background Pattern */}
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-7 gap-2 mb-8 bg-white/5 backdrop-blur-md border-none rounded-2xl p-4 neon-border-inner shadow-2xl">
...
function StatCard({ icon: Icon, label, value, sublabel, trend, trendUp, color }: StatCardProps) {
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-md border-none p-4 hover:bg-white/10 transition-all cursor-pointer neon-border-inner shadow-2xl">
