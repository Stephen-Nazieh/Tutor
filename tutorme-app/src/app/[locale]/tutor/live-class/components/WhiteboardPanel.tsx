...
export function WhiteboardPanel({ onClose }: WhiteboardPanelProps) {
  ...
  return (
    <div className="absolute inset-4 z-40 flex flex-col overflow-hidden rounded-lg bg-white shadow-2xl">
      {/* Toolbar */}
          ...
          <div className="flex items-center rounded-lg border bg-white p-1">
            {[
              ...
              <button
                ...
                className={`rounded p-2 ${tool === id ? 'bg-blue-100 text-blue-600' : 'hover:bg-gray-100'}`}
              >
