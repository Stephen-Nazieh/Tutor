      ...
      <div className="grid grid-cols-2 gap-3">
        <Card>
          <CardContent className="p-4">
            <div className="flex items-start justify-between">
              <div>
                <p className="mb-1 text-xs text-gray-500">Avg. Engagement</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-start justify-between">
              <div>
                <p className="mb-1 text-xs text-gray-500">Active Students</p>
                <p className="text-2xl font-bold">{metrics.activeStudents}</p>
              </div>
              <Users className="h-5 w-5 text-green-500" />
            </div>
            <div className="mt-2">
              <span className="text-xs text-gray-500">of {metrics.totalStudents} total</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-start justify-between">
              <div>
                <p className="mb-1 text-xs text-gray-500">Class Duration</p>
            ...
            <div className="mt-2">
              <span className="text-xs text-gray-500">
                Started{' '}
                {new Date(metrics.classStartTime).toLocaleTimeString([], {
                  hour: '2-digit',
                  minute: '2-digit',
                })}
              </span>
        ...
        <CardContent className="pt-0">
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="w-10 text-right text-xs">{veryEngagedPct}%</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="w-10 text-right text-xs">{engagedPct}%</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="w-10 text-right text-xs">{passivePct}%</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="w-10 text-right text-xs">{disengagedPct}%</span>
            </div>
          </div>
        </CardContent>
      </Card>
