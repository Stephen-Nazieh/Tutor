...
function generateOccurrences(rrule: any, event: any, rangeStart: Date, rangeEnd: Date): any[] {
...
async function createReminderNotifications(
  event: { id: string; title: string; startTime: Date; reminders?: Array<{ minutes: number }> },
  tutorId: string
) {
