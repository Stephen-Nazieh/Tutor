...
describe('/api/admin/llm/routing guards', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  it('POST returns 400 when required fields are missing', async () => {
    ...
    expect(await res.json()).toEqual({ error: 'Target model and conditions are required' })
  })
  ...
  it('DELETE returns 400 when id query param is missing', async () => {
    ...
    const req = new Request('http://localhost/api/admin/llm/routing', { method: 'DELETE' })
