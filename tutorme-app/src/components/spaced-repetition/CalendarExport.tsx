...
import { Calendar, Download, Check, GoogleChrome, Apple, Outlook } from 'lucide-react'
    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          <Button variant="outline" className="w-full justify-center" onClick={handleDownloadICS}>
        ...
        <div className="border-t pt-3">
          <p className="mb-3 text-sm text-gray-500">What you'll get:</p>
