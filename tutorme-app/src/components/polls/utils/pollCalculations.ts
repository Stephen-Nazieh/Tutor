 ...
 */
export function calculatePollStatistics(poll: Poll, totalStudents: number): PollStatistics {
 ...
 */
export function updatePollWithStatistics(poll: Poll, totalStudents: number): Poll {
