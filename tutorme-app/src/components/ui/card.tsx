  ...
  ],
  {
    variants: {
      ...
      variant: {
        ...
        outlined: ['bg-transparent', 'border-border border-2', 'shadow-none', 'hover:shadow-none'],
        ghost: [
          'bg-transparent',
          'border-0',
          'shadow-none',
...
>(({ className, spacing = 'default', bordered = false, align = 'start', ...props }, ref) => {
  const alignClasses = {
    start: 'justify-start',
