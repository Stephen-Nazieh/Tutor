...
export default function MessagingPanel({ activeSection, onSectionChange }: MessagingPanelProps) {
  ...
  return (
    <Card className="flex h-full w-full flex-col overflow-hidden rounded-2xl border-0 bg-white shadow-[0_14px_45px_rgba(0,0,0,0.14)]">
      ...
      <div className="flex h-12 shrink-0 items-center justify-center rounded-t-none bg-gradient-to-br from-[#2563EB] to-[#1D4ED8] px-4 text-sm font-semibold text-white">
        Chat
      </div>
