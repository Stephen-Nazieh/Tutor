;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="de6500f8-8f36-7584-6fe0-9a7ca4ad1dd4")}catch(e){}}();
module.exports = [
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(async (_req, session)=>{
    ...
    try {
        const [profile, totalClasses, sessionIds, upcomingCount, directTutorPayments, clinicPayments] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].profile.findUnique({
                where: {
                    userId: tutorId
                },
                select: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].liveSession.count({
                where: {
                    tutorId
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].liveSession.findMany({
                where: {
                    tutorId
                },
                select: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].payment.findMany({
                where: {
                    status: 'COMPLETED',
                    tutorId
                },
        ...
        if (sessionIds.length > 0) {
            const participants = await __TURBOPACK__imported__module__$5b$project$5d2f$ADK_WORKSPACE$2f$TutorMekimi$2f$tutorme$2d$app$2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].sessionParticipant.findMany({
                where: {
                    sessionId: {
                        in: sessionIds.map((s)=>s.id)
                    }
                },
                select: {
                    studentId: true
...
//# debugId=de6500f8-8f36-7584-6fe0-9a7ca4ad1dd4
//# sourceMappingURL=%5Broot-of-the-server%5D__f122dcac._.js.map